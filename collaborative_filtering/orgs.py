...
class CF_orgs():
  ...
  def __init__(self,orgs_clicking,orgs_category,k,number_of_recommend):
    self.k=k
    self.clicking=orgs_clicking
    
    self.recommended_items_final=[]
    self.category=orgs_category
  ...
  #update data
  def refresh_data(self,orgs_clicking,orgs_category):
    self.clicking=orgs_clicking
    self.category=orgs_category
  ...
  def welcome_recommend(self,user_id):
    ...
    try:
      ...
      dic['care_orgs']=recommended_items_CF
    except:
      pass
